...
const csvOrPdfRoute = require("./modules/csvOrPdfDownload/csvAndPdfRoute");
const googleMeetRoute = require("./modules/googleMeet/route");
const villagePeopleRoute = require("./modules/villagePeople/route");

app.use(
  cors({
    origin: ["http://localhost:3000", "https://rbcweb.vercel.app","https://rbcweb.site","https://api.rbcweb.site/"],
  })
);
...
//csv or Pdf
app.use("/api/v1/pdv-csv-generate",csvOrPdfRoute);


//google Meet
app.use("/api/v1/google-meet",googleMeetRoute);

//village People
app.use("/api/v1/village-people",villagePeopleRoute);
